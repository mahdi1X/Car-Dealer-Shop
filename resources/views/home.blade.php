...
@section('content')
    ...
    <div class="container-fluid p-0 mb-5">
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                @foreach ([
                    ['bg' => 'carousel-bg-1.jpg', 'img' => 'carousel-1.png', 'title' => 'List and Buy Cars'],
                    ['bg' => 'carousel-bg-2.jpg', 'img' => 'carousel-2.png', 'title' => 'Display Your Cars Under Variety Of Brands']
                ] as $index => $slide)
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-4">
                @foreach ([
                    ['icon' => 'fa-certificate', 'title' => 'Quality Servicing', 'desc' => 'Top-notch car hosting services.'],
                    ['icon' => 'fa-users-cog', 'title' => 'Fast Response', 'desc' => 'Instant access to your reserved car.'],
                    ['icon' => 'fa-tools', 'title' => 'You are the controller', 'desc' => 'Full flexibility on time and pickup.']
                ] as $i => $service)
    ...
    <div class="container-fluid fact bg-dark my-5 py-5">
        <div class="container">
            <div class="row g-4 text-center text-white">
                @foreach ([
                    ['icon' => 'fa-check', 'count' => '12', 'label' => 'Years Experience'],
                    ['icon' => 'fa-users-cog', 'count' => '30', 'label' => 'Expert Technicians'],
                    ['icon' => 'fa-users', 'count' => '+12k', 'label' => 'Satisfied Clients'],
                    ['icon' => 'fa-car', 'count' => '15633', 'label' => 'Sold Cars']
                ] as $i => $fact)
            ...
            <div class="row g-4 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="col-lg-8">
                    <div class="tab-content">
                        @foreach (['mercedes', 'bmw', 'audi', 'volkswagen'] as $i => $brand)
                            <div class="tab-pane fade {{ $i == 0 ? 'show active' : '' }}" id="tab-pane-{{ $i + 1 }}">
                                <div class="row g-4">
                                    <div class="col-md-6" style="min-height: 350px;">
                                        <div class="position-relative h-100">
                                            <img class="position-absolute img-fluid w-100 h-100"
                                                 src="img/{{ $brand }}.jpg" style="object-fit: cover;" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <h3 class="mb-3">Trusted Expertise in {{ ucfirst($brand) }}</h3>
                                        <p class="mb-4">Browse cars from your favorite brand with quality assurance and full control.</p>
                ...
                @foreach ([1, 2, 3, 4] as $n)
                    <div class="testimonial-item text-center">
                        ...
                        <div class="testimonial-text bg-light text-center p-4">
                            <p class="mb-0">Excellent experience! Seamless process and great selection of cars.</p>
                        </div>
                    </div>
                @endforeach
            </div>
